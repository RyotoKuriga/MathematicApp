      ...
      <ScrollView>
        <View style={[stylesTheorie.container, {backgroundColor: theme.mode === 'dark' ? activeColors.background : 'white'}]}>
          ...
          <View style={stylesTheorie.imageContainer}>
            <Image source={theme.mode === 'dark' ? require('./img/Wertetabelle-2x-dark.png') : require('./img/Wertetabelle-2x.png')} style={{ width: 300, height: 320 }} />
          </View>
          ...
          <View style={stylesTheorie.imageContainer}>
            <Image source={theme.mode === 'dark' ? require('./img/Funktion-2x-dark.png') : require('./img/Funktion-2x.png')} style={{ width: 300, height: 600 }} />
          </View>
