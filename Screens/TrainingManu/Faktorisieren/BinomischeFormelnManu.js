...
export function BinomischeFormelnManu() {
  ...
  const AufgabenUndLoesungen = [
    ...
    },
    {
      ...
      loesung: "$16a^2 - 64b^2 = (4a^2 + 8b)(4a^2 - 8b)$"
    },
    {
      aufgabe: "e) $\\square + \\square + 16u^2  = (12q + \\square)$",
      loesung: "$144q^2 + 96qu + 16u^2  = (12q + 4u)$"
    },
    {
    ...
    {
      titel: "Multipliziere aus:", //ausmultiplizieren
      aufgabe: "a) $(5x + 4)^2 $",
    ...
    {
      titel: "Klammere erst aus und bilde dann das Binom:", //Binombildung
